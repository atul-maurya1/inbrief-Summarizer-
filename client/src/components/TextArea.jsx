...
const TextArea = () => {
    return(
         <>
         <div
								className="text-sm font-medium text-slate-700  bg-gray-100 mt-5 py-3 px-5 flex justify-between border border-gray-300 rounded-t-xl"
							>
								<span className="text-gray-700" >Enter or paste your text</span> <button className="hover:text-blue-400" >Clear</button>
							</div>
